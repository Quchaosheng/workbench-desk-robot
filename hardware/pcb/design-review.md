...
48 V battery
  ...
  -> isolated 48-to-12 V / 240 W module
       ...
       -> 5 V / 10 A synchronous buck -> Jetson auxiliary power
...
Power-good sequencing is `12V_ISO` then `5V_JETSON` then `3V3_LOGIC` with 10 ms
...
The 40 W Jetson load is external to this board; its 5 V converter loss is estimated
from efficiency and placed at the board edge against the chassis heat spreader.
