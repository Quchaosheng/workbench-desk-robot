...
| PCB6 | eight-layer 160 x 130 mm board, 114 footprints, 1,250 track/via items, 30 copper zones, 8 SMT test pads, Gerber/drill/IPC-D-356 | CONCEPT DRC CLEAN; U2 footprint/placement/routing must be replaced by ECO after MPN freeze |
...
| PCB8 | CAN rules, matched RAW blind-via transitions, zero-via field routes, In1 isolated reference-zone declaration and open-risk audit | DESIGN COMPLETE; coupling/stub review and fabricator impedance coupon external |
